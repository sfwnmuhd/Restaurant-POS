...
const TableCard = ({key,name, status, initials, seats}) => {
  ...
  return (
    <div onClick={()=> handleClick(name)} key={key} className='w-[300px] bg-[#262626] p-4 rounded-lg  cursor-pointer'>
      ...
      <div className='flex items-center justify-center my-5'>
            <h1 className={` ${getRandomBG()} text-white rounded-full p-5 text-2xl`}>{getAvatarName(initials) || "N/A"}</h1>
      </div>

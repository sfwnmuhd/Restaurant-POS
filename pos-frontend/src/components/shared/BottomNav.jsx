...
const BottomNav = () => {
  ...
  return (
    <div className='fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around'>
      ...
      <button className='flex items-center justify-center text-[#ababab] w-[200px] cursor-pointer'><CiCircleMore className='inline mr-2' size={20}/><p>More</p></button>

      <button disabled={isActive("/tables") || isActive("/menu")}  onClick={openModal} className='bg-[#F6B100] text-[#f5f5f5] rounded-full p-3 items-center absolute bottom-6'>
        <BiSolidDish size={30}/>
      </button>
